...
def programstart(): #08:40 영웅문 아이콘 클릭 및 접속
    ...
    pyautogui.click()
    time.sleep(10)
    pyautogui.hotkey('i', interval=0.2) #핀번호 입력
    pyautogui.hotkey('c', interval=0.2)
    pyautogui.hotkey('a', interval=0.2)
    pyautogui.hotkey('n', interval=0.2)
    pyautogui.hotkey('d', interval=0.2)
    pyautogui.hotkey('o', interval=0.2)
    pyautogui.hotkey('i', interval=0.2)
    pyautogui.hotkey('t', interval=0.2)
    pyautogui.hotkey('6', interval=0.2)
    pyautogui.hotkey('3', interval=0.2)
    pyautogui.hotkey('1', interval=0.2)
    pyautogui.hotkey('1', interval=0.2)
